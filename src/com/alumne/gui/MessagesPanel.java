...
public class MessagesPanel extends JPanel {
	...
	public MessagesPanel() {
		...
		btnToDashboardTxt.setIcon(new ImageIcon(MessagesPanel.class.getResource("/com/alumne/images/left-chevron.png")));
		...
		JLabel title = new JLabel("Missatges");
		title.setFont(new Font("Open Sans", Font.BOLD, 20));
		title.setBounds(26, 58, 99, 28);
		panel.add(title);
