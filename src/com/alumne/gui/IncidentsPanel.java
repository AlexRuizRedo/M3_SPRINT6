...
public class IncidentsPanel extends JPanel {
	...
	public IncidentsPanel() {
		...
		btnToDashboardTxt.setIcon(new ImageIcon(IncidentsPanel.class.getResource("/com/alumne/images/left-chevron.png")));
		...
		JLabel title = new JLabel("Incidencies");
		title.setFont(new Font("Open Sans", Font.BOLD, 20));
		title.setBounds(26, 58, 111, 28);
		panel.add(title);
